...
class PersonalWorkOffTracker {
    ...
    public function fetchRecords() {
        $sql = "SELECT * FROM daily ORDER BY id DESC LIMIT 5";
        $limit = 5;
        $currentPage = $_GET['page'];
        //$a = $b -> pdo -> quer("SELECT * FROM daily LIMIT $currentPage, $limit"); 
...
<div class="container">
  ...
  <ul class="pagination">
    ...
    <li class="page-item active" aria-current="page">
      <a class="page-link" href="?page=5">2</a>
    </li>
    <li class="page-item"><a class="page-link" href="?page=15">3</a></li>
    <li class="page-item">
      <a class="page-link" href="?page=20">Next</a>
    </li>
  </ul>
</nav>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="#exampleModalLabel<?php echo $day['id']; ?>"Tasdiqlash</h5>
